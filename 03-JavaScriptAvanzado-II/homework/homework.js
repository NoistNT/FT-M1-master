...
otroContador()      // 2 */
function counter() {
  //Aca van a estar todas las cosas que se guardan en la closure
  let num = 1
  return () => {
    return num++
  }
...
//   let cache = {}
//   return function(arg) {
//     // Si ya existe la propiedad
//     if (cache.hasOwnProperty(arg)) {
//       return cache[arg]
//     }
//     // guardando el resultado (si no existia y retornarlo)
//     return cache[arg] = cb(arg)
//   }
// }
